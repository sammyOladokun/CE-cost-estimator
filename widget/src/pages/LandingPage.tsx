    ...
    <div className="landing-shell">
      <header className="landing-hero">
        <div className="hero-copy">
          ...
          <p className="nx-subtle">
            Gated demo: capture the lead before revealing the satellite view + estimate.
          </p>
        </div>
        <form className="hero-bar" onSubmit={handleHeroSubmit} style={glassStyles}>
          <input
            aria-label="address"
            placeholder="Enter address to test the AI"
            value={address}
      ...
      <section className="demo-preview" style={glassStyles}>
        <div>
          ...
          <p className="nx-subtle">
            Sandbox mode until a license is active. Data reveals only after the form.
          </p>
